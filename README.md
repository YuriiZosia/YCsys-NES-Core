...
### 4. 💾 Cartridge & Mapper
- [x] **iNES:** Парсинг заголовку файлу `.nes`
- [x] **NROM:** Реалізація базового Mapper 000
- [x] **Маршрутизація:** PRG ROM (процесор) / CHR ROM (графіка)

### 5. 👁️ PPU - База та Логіка (Графіка)
- [x] **Регістри PPU:** PPUCTRL, PPUDATA, PPUADDR тощо
- [x] **Пам'ять:** VRAM, Palettes, Pattern Tables
- [x] **Фон:** Рендеринг бекграунду та скролінг
- [x] **Спрайти:** OAM (Object Attribute Memory) та Sprite 0 Hit

### 6. 🔗 Інтеграція та Периферія
- [x] **Синхронізація:** 1 такт CPU = 3 такти PPU
- [x] **Рендеринг SDL2:** Вивід текстури 256x240 на екран
- [x] **Керування:** Читання стану Joypad через порт `$4016`

### 7. 🛠 Системні механіки
- [x] **VRAM Mirroring:** Горизонтальне та вертикальне віддзеркалення
- [x] **Переривання:** NMI (Non-Maskable Interrupt)
- [x] **APU:** Аудіо співпроцесор (Pulse, Triangle, Noise)

### 8. 🧪 Тестування
- [x] **Nestest.nes:** Проходження тестового ROM-файлу
- [x] **Логи:** Порівняння виводу з еталонним логом виконання Nintendulator
