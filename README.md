...
- [ ] **Пам'ять:** Реалізація читання/запису на загальній шині (Bus 64KB)
- [ ] **Адресація:** 12 режимів адресації 

### 3. ⚡ CPU (MOS 6502) - Опкоди
- [ ] **Завантаження/Збереження:** LDA, STA та інші
- [ ] **Арифметика:** ADC, SBC
- [ ] **Інкремент/Декремент:** INC, DEC, INX, INY...
- [ ] **Зсуви та Логіка:** AND, ORA, ASL, ROL...
- [ ] **Стрибки та Переходи:** JMP, Branches (BNE, BEQ...)
- [ ] **Робота з прапорцями та Стеком**
